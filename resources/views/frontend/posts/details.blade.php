                            ...
                            <div class="pd-breadcrumb u-s-m-b-30">
                                <ul class="pd-breadcrumb__list">
                                    ...
                                    <li class="has-separator">
                                        ...
                                        <a href="shop-side-version-2.html">{{ $post->name }}</a></li>
                                    <li class="has-separator">
                            ...
                            <div class="pd u-s-m-b-30">
                                <div class="slider-fouc pd-wrap">
                                    <div id="pd-o-initiate">
                                        <div class="pd-o-img-wrap" data-src="{{ asset('public/frontend/products/images/'.$post->image) }}">

                                            <img class="u-img-fluid" src="{{ asset('public/frontend/products/images/'.$post->image) }}" data-zoom-image="{{ asset('public/frontend/products/images/'.$post->image) }}" alt=""></div>
                                            <div class="pd-o-img-wrap" data-src="{{ asset('public/frontend/products/images/'.$post->image) }}">
                                    ...
                                    <div class="slider-fouc">
                                        <div id="pd-o-thumbnail">
                                            <div>
                                                ...
                                                <img class="u-img-fluid" src="{{ asset('public/frontend/products/images/'.$post->image) }}" alt="">
                                            </div>
                                            <div>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="pd-detail">
                                <div>
                                    ...
                                    <span class="pd-detail__name">{{ $post->name }}</span></div>
                                <div>
                                    <div class="pd-detail__inline">

                                        <span class="pd-detail__price">{{ $post->b_rate }}</span>

                                        <span class="pd-detail__discount">(76% OFF)</span><del class="pd-detail__del">{{ $post->b_rate }}</del></div>
                                </div>
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <span class="pd-detail__preview-desc">{{ $post->description }}</span></div>
                                <div class="u-s-m-b-15">
                                    <div class="pd-detail__inline">
                                ...
                                <div class="u-s-m-b-15">
                                    <form class="pd-detail__form" action="{{ route('add.to.cart',$post->id) }}" method="post">
                                        @csrf
                                        <div class="pd-detail-inline-2">
                                            <div class="u-s-m-b-15">
                                                ...
                                                <div class="input-counter">
                                                    ...
                                                    <input name="qty" class="input-counter__text input-counter--text-primary-style" type="text" value="1" data-min="1" data-max="1000" value="{{ $post->qty }}">
